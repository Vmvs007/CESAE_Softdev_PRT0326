...
public class NavegacaoHeroi {


    public static int inicio_01() {
        Scanner input = new Scanner(System.in);

        Heroi jogador = Heroi.getInstance("Quim",0,0,0);

        System.out.println("\nBem-vindo "+ jogador.getNome() +" à Aventura Espetacular");
    ...
    public static int florestaMagica_02() {
        ...
        Heroi jogador = Heroi.getInstance("",0,0,0);

        System.out.println("\nBem-vindo/a " +jogador.getNome()+" à Floresta Mágica");
    ...
    public static void main(String[] args) {
        ...
        Heroi jogador = Heroi.getInstance(nome,1,100,5);
